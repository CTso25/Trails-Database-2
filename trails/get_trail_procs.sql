...
begin
	...
	case
		...
		when (feat_1_var is not null and feat_2_var is null and feat_3_var is null
			and feat_4_var is not null and feat_5_var is null) then
            select concat(trail_name_var,' has ',feat_1_var,' and ', feat_4_var,' as features.') into message;
		when (feat_1_var is not null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is not null and feat_5_var is null) then
            select concat(trail_name_var,' has ',feat_1_var,' , ',feat_2_var,' , ',
				feat_4_var,' as features.') into message;
		when (feat_1_var is not null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is not null and feat_5_var is not null) then
            select concat(trail_name_var,' has ',feat_1_var,' , ',feat_2_var,' , ',
...
drop function if exists find_ranking;

delimiter //

create function find_ranking
(
	trail_id_param int,
    feature_id_1_param int,
    feature_id_2_param int,
...
begin
    ...
    case
		when (feature_id_1_param is not null and feature_id_2_param is not null and 
			feature_id_3_param is not null and feature_id_4_param is not null and 
			feature_id_5_param is not null) then set num_features = 5;
		when (feature_id_1_param is not null and feature_id_2_param is not null and
			feature_id_3_param is not null and feature_id_4_param is not null and 
			feature_id_5_param is null) then set num_features = 4;
		when (feature_id_1_param is not null and feature_id_2_param is not null and
			feature_id_3_param is not null and feature_id_4_param is null and 
			feature_id_5_param is null) then set num_features = 3;
		when (feature_id_1_param is not null and feature_id_2_param is not null and
			feature_id_3_param is null and feature_id_4_param is null and 
			feature_id_5_param is null) then set num_features = 2;
		when (feature_id_1_param is not null and feature_id_2_param is null and
			feature_id_3_param is null and feature_id_4_param is null and 
			feature_id_5_param is null) then set num_features = 1;
	end case;
    ...
    case
		when (num_features = 1 and feat_1_var is not null) then set score = 5;
        when (num_features = 1 and feat_1_var is null) then set score = 0;
        when (num_features = 2 and feat_1_var is not null and feat_2_var is not null)
			then set score = 5;
		when (num_features = 2 and feat_1_var is not null and feat_2_var is null) then
			set score = 3.5;
		when (num_features = 2 and feat_1_var is null and feat_2_var is not null) then
			set score = 1.5;
		when (num_features = 2 and feat_1_var is null and feat_2_var is null) then 
			set score = 0;
		when (num_features = 3 and feat_1_var is not null and feat_2_var is null and feat_3_var is null)
			then set score = 2;
		when (num_features = 3 and feat_1_var is null and feat_2_var is not null and feat_3_var is null)
			then set score = 1.67;
		when (num_features = 3 and feat_1_var is null and feat_2_var is null and feat_3_var is not null)
			then set score = 1.33;
		when (num_features = 3 and feat_1_var is not null and feat_2_var is not null and feat_3_var is null)
			then set score = 3.67;
		when (num_features = 3 and feat_1_var is not null and feat_2_var is null and feat_3_var is not null)
			then set score = 3.33;
		when (num_features = 3 and feat_1_var is null and feat_2_var is not null and feat_3_var is not null)
			then set score = 3;
		when (num_features = 3 and feat_1_var is not null and feat_2_var is not null and feat_3_var is not null)
			then set score = 5;
		when (num_features = 3 and feat_1_var is null and feat_2_var is null and feat_3_var is null)
			then set score = 0;
		when (num_features = 4 and feat_1_var is not null and feat_2_var is null and feat_3_var is null 
			and feat_4_var is null) then set score = 2;
		when (num_features = 4 and feat_1_var is null and feat_2_var is not null and feat_3_var is null 
			and feat_4_var is null) then set score = 1.5;
		when (num_features = 4 and feat_1_var is null and feat_2_var is null and feat_3_var is not null 
			and feat_4_var is null) then set score = 1;
		when (num_features = 4 and feat_1_var is null and feat_2_var is null and feat_3_var is null
			and feat_4_var is not null) then set score = 0.5;
		when (num_features = 4 and feat_1_var is not null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is null) then set score = 3.5;
		when (num_features = 4 and feat_1_var is not null and feat_2_var is null and feat_3_var is not null
			and feat_4_var is null) then set score = 3;
		when (num_features = 4 and feat_1_var is not null and feat_2_var is null and feat_3_var is null
			and feat_4_var is not null) then set score = 2.5;
		when (num_features = 4 and feat_1_var is null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is null) then set score = 2.5;
		when (num_features = 4 and feat_1_var is null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is not null) then set score = 2;
		when (num_features = 4 and feat_1_var is null and feat_2_var is null and feat_3_var is not null
			and feat_4_var is not null) then set score = 1.5;
		when (num_features = 4 and feat_1_var is not null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is null) then set score = 4.5;
		when (num_features = 4 and feat_1_var is not null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is not null) then set score = 4;
		when (num_features = 4 and feat_1_var is not null and feat_2_var is null and feat_3_var is not null
			and feat_4_var is not null) then set score = 3.5;
		when (num_features = 4 and feat_1_var is null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is not null) then set score = 3;
		when (num_features = 4 and feat_1_var is not null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is not null) then set score = 5;
		when (num_features = 4 and feat_1_var is null and feat_2_var is null and feat_3_var is null
			and feat_4_var is null) then set score = 0;
		when (num_features = 5 and feat_1_var is null and feat_2_var is null and feat_3_var is null
			and feat_4_var is null and feat_5_var is null) then set score = 0;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is null and feat_3_var is null
			and feat_4_var is null and feat_5_var is null) then set score = 1.4;
		when (num_features = 5 and feat_1_var is null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is null and feat_5_var is null) then set score = 1.2;
		when (num_features = 5 and feat_1_var is null and feat_2_var is null and feat_3_var is not null
			and feat_4_var is null and feat_5_var is null) then set score = 1;
		when (num_features = 5 and feat_1_var is null and feat_2_var is null and feat_3_var is null
			and feat_4_var is not null and feat_5_var is null) then set score = 0.8;
		when (num_features = 5 and feat_1_var is null and feat_2_var is null and feat_3_var is null
			and feat_4_var is null and feat_5_var is not null) then set score = 0.6;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is null and feat_5_var is null) then set score = 2.6;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is null and feat_3_var is not null
			and feat_4_var is null and feat_5_var is null) then set score = 2.4;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is null and feat_3_var is null
			and feat_4_var is not null and feat_5_var is null) then set score = 2.2;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is null and feat_3_var is null
			and feat_4_var is null and feat_5_var is not null) then set score = 2;
		when (num_features = 5 and feat_1_var is null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is null and feat_5_var is null) then set score = 2.2;
		when (num_features = 5 and feat_1_var is null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is not null and feat_5_var is null) then set score = 2.0;
		when (num_features = 5 and feat_1_var is null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is null and feat_5_var is not null) then set score = 1.8;
		when (num_features = 5 and feat_1_var is null and feat_2_var is null and feat_3_var is not null
			and feat_4_var is not null and feat_5_var is null) then set score = 1.8;
		when (num_features = 5 and feat_1_var is null and feat_2_var is null and feat_3_var is not null
			and feat_4_var is null and feat_5_var is not null) then set score = 1.6;
		when (num_features = 5 and feat_1_var is null and feat_2_var is null and feat_3_var is null
			and feat_4_var is not null and feat_5_var is not null) then set score = 1.4;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is null and feat_5_var is null) then set score = 3.6;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is not null and feat_5_var is null) then set score = 3.4;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is null and feat_5_var is not null) then set score = 3.2;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is null and feat_3_var is not null
			and feat_4_var is not null and feat_5_var is null) then set score = 3.2;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is null and feat_3_var is not null
			and feat_4_var is null and feat_5_var is not null) then set score = 3;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is null and feat_3_var is null
			and feat_4_var is not null and feat_5_var is not null) then set score = 2.8;
		when (num_features = 5 and feat_1_var is null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is not null and feat_5_var is null) then set score = 3;
		when (num_features = 5 and feat_1_var is null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is null and feat_5_var is not null) then set score = 2.8;
		when (num_features = 5 and feat_1_var is null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is not null and feat_5_var is not null) then set score = 2.6;
		when (num_features = 5 and feat_1_var is null and feat_2_var is null and feat_3_var is not null
			and feat_4_var is not null and feat_5_var is not null) then set score = 2.4;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is not null and feat_5_var is null) then set score = 4.4;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is null and feat_5_var is not null) then set score = 4.2;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is not null and feat_3_var is null
			and feat_4_var is not null and feat_5_var is not null) then set score = 4;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is null and feat_3_var is not null
			and feat_4_var is not null and feat_5_var is not null) then set score = 3.8;
		when (num_features = 5 and feat_1_var is null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is not null and feat_5_var is not null) then set score = 3.6;
		when (num_features = 5 and feat_1_var is not null and feat_2_var is not null and feat_3_var is not null
			and feat_4_var is not null and feat_5_var is not null) then set score = 5;
...
-- finding hike using ranking system: 
drop procedure if exists find_the_best_hike;

delimiter //

create procedure find_the_best_hike
(
	in park_param varchar(250),
    in difficulty_param ENUM('Easy', 'Moderate', 'Hard'),
    in dist_min_param decimal(4,2),
...
begin
    ...
    select 
        ...
        get_features(trail.trail_id, feature_id_var_1, feature_id_var_2, feature_id_var_3, 
			feature_id_var_4, feature_id_var_5) 'features',
        get_messages(trail.trail_id) 'messages',
        find_ranking(trail.trail_id, feature_id_var_1, feature_id_var_2, feature_id_var_3, 
			feature_id_var_4, feature_id_var_5) 'score'
    from trail left join trail_has_feature using (trail_id)
    left join review using (trail_id)
    where trail.park_id = park_id_var
    and 1 = CASE
